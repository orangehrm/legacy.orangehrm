...
?>
	<div id="editPaneContracts" >
      ...
      <tr>
    	  ...
    	  <td>
    	  	<input type="text" readonly name="txtEmpConExtStartDat" id="etxtEmpConExtStartDat" value=<?php echo $edit[0][2]?> size="12" />
    	  	<input class="button" type="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpConExtStartDat', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
	  </tr>
	  <tr>
		<td valign="top"><?php echo $lang_hremp_ContractExtensionEndDate; ?></td>
		<td align="left" valign="top">
			<input type="text" readonly name="txtEmpConExtEndDat" id="etxtEmpConExtEndDat" value=<?php echo $edit[0][3]?> size="12" />
			<input type="button" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpConExtEndDat', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
	  </tr>
	  <tr>
		<td valign="top"></td>
		<td align="left" valign="top">
