   	...
   	<div id="addPaneEducation" class="<?php echo ($this->popArr['rsetEducation'] != null)?"addPane":""; ?>" >
    	<table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
					...
					<td><?php echo $lang_hrEmpMain_startdate?></td>
						<td>
							<input type="text" name="txtEmpEduStartDate" id="atxtEmpEduStartDate" readonly value="0000-00-00" size="12" />
							<input type="button" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('atxtEmpEduStartDate', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
					</tr>
					  <tr>
						<td><?php echo $lang_hrEmpMain_enddate?></td>
						<td>
							<input type="text" name="txtEmpEduEndDate" id="atxtEmpEduEndDate" readonly value="0000-00-00" size="12" />
							<input type="button" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('atxtEmpEduEndDate', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
					 </tr>
...
?>
	<div id="editPaneEducation" >
		<table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
					...
					<td><?php echo $lang_hrEmpMain_startdate?></td>
						<td>
							<input type="text" name="txtEmpEduStartDate" id="etxtEmpEduStartDate" readonly value=<?php echo $edit[0][5]?> size="12" />
							<input disabled type="button" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpEduStartDate', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
					</tr>
					  <tr>
						<td><?php echo $lang_hrEmpMain_enddate?></td>
						<td>
							<input type="text" name="txtEmpEduEndDate" id="etxtEmpEduEndDate" readonly value=<?php echo $edit[0][6]?> size="12" />
							<input disabled type="button" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpEduEndDate', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
					 </tr>
