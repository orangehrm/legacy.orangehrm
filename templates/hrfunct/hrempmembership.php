...
?>
					  ...
					  <tr>
						<td valign="top"><?php echo $lang_hrEmpMain_subcomdate?></td>
						<td align="left" valign="top">
							<input type="text" readonly disabled name="txtMemCommDat" id="etxtMemCommDat" value=<?php echo $edit[0][5]?> size="12" />
							<input class="button" disabled type="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtMemCommDat', 'cal1Container', 'yyyy-MM-dd'); return false;">
						</td>
					  </tr>
					  <tr>
						<td valign="top"><?php echo $lang_hrEmpMain_subredate?></td>
						<td align="left" valign="top">
							<input type="text" readonly disabled name="txtMemRenDat" id="etxtMemRenDat" value=<?php echo $edit[0][6]?> size="12" />
							<input class="button" disabled type="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtMemRenDat', 'cal1Container', 'yyyy-MM-dd'); return false;">
						</td>
					  </tr>
