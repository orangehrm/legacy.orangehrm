...
?>
					...
					<tr>
                      	<td><?php echo $lang_hrEmpMain_startdate?></td>
						<td>
							<input type="text" readonly name="txtEmpLicDat" id="etxtEmpLicDat" value=<?php echo isset($this->popArr['txtEmpLicDat']) ? $this->popArr['txtEmpLicDat'] : $edit[0][2]?> size="12" />
							<input disabled type="button" name="btnEmpLicDat" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpLicDat', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
    				<tr>
						<td><?php echo $lang_hrEmpMain_enddate?></td>
						<td>
							<input type="text" readonly name="txtEmpreDat" id="etxtEmpreDat" value=<?php echo isset($this->popArr['txtEmpreDat']) ? $this->popArr['txtEmpreDat'] : $edit[0][3]?> size="12" />
							<input disabled type="button" name="btnEmpreDat" class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('etxtEmpreDat', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
					</tr>
					 <tr>
						<td valign="top"></td>
						<td align="left" valign="top">
