...
?>
	<div id="editPaneChildren" >
		<table height="100" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><?php echo $lang_hremp_dateofbirth?></td>
                <td><input type="text" name="ChiDOB" id="eChiDOB" readonly value=<?php echo $edit[0][3]?> size="12">
                	<input type="button" <?php echo $locRights['edit'] ? '':'disabled'?> class="button" value="..." onclick="YAHOO.OrangeHRM.calendar.pop('eChiDOB', 'cal1Container', 'yyyy-MM-dd'); return false;"></td>
               </tr>
...
//checking for the records if exsists show the children table and the delete btn else hide
	...
	if ($rset != null) {?>
		<?php if($locRights['add']) { ?>
        <img border="0" title="Add" onClick="showAddPane('Children');" onMouseOut="this.src='../../themes/beyondT/pictures/btn_add.jpg';" onMouseOver="this.src='../../themes/beyondT/pictures/btn_add_02.jpg';" src="../../themes/beyondT/pictures/btn_add.jpg" />
		<?php } ?>
