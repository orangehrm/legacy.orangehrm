...
SectionGroup /e "OrangeHRM Appliance" SecGrpOrangeHRMAppliance
    ...
    Section "OrangeHRM 3.0-rc.1" SecOrangeHRM
...
Section "-Register the application"
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "DisplayVersion" "3.0-rc.1"
...
; Descriptions
  ...
  LangString DESC_SecOrangeHRM ${LANG_ENGLISH} "OrangeHRM 3.0-rc.1"
