...
SectionGroup /e "OrangeHRM Appliance" SecGrpOrangeHRMAppliance
    ...
    Section "OrangeHRM 2.4.1-alpha.2" SecOrangeHRM
...
Section "-Register the application"
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "DisplayVersion" "2.4.1-alpha.2"
...
; Descriptions
  ...
  LangString DESC_SecOrangeHRM ${LANG_ENGLISH} "OrangeHRM 2.4.1-alpha.2"
