...
create table `hs_hr_job_application_events` (
  ...
  `attach2_name` varchar(100) default null,
  `attach2_type` varchar(100) default null,
  `attach2_data` mediumblob default null,
  primary key  (`id`),
...
INSERT INTO `hs_hr_module` VALUES ('MOD001','Admin','Koshika','koshika@beyondm.net','VER001','HR Admin'),
								  ...
								  ('MOD010', 'Health', 'OrangeHRM', 'info@orangehrm.com', 'VER001', 'Health'),
								  ('MOD011', 'Training', 'OrangeHRM', 'info@orangehrm.com', 'VER001', 'Training'),
								  ('MOD012', 'Budget', 'OrangeHRM', 'info@orangehrm.com', 'VER001', 'Budget');
...
VALUES  ('USG001', 'MOD001', '1', '1', '1', '1'),
		...
		('USG001', 'MOD010', '1', '1', '1', '1'),
		('USG001', 'MOD011', '1', '1', '1', '1'),
		('USG001', 'MOD012', '1', '1', '1', '1');
...
(1, 'Are you able to pass a police clearance?', 'radio', NULL, NULL, NULL, NULL, NULL, 'Are you able to pass a police clearance?', NULL, NULL, 44, 0, NULL),
(2, 'Do you have any injuries, medical or other issues that might impact on the position you are applying for?', 'radio', NULL, NULL, NULL, NULL, NULL, 'Do you have any injuries, medical or other issues that might impact on the position you are applying for?', NULL, NULL, 45, 0, NULL),
(3, 'If yes please specify', 'text', NULL, NULL, NULL, NULL, NULL, 'If yes please specify', NULL, NULL, 46, 0, NULL),
(4, 'Are you aware of any conflicts of interest that would be created if you worked for ORS?', 'radio', NULL, NULL, NULL, NULL, NULL, 'Are you aware of any conflicts of interest that would be created if you worked for ORS?', NULL, NULL, 47, 0, NULL),
(5, 'If yes please specify', 'text', NULL, NULL, NULL, NULL, NULL, 'If yes please specify', NULL, NULL, 48, 0, NULL),
(6, 'Please specify the reason for leaving your last employment', 'textarea', NULL, NULL, NULL, NULL, NULL, 'Please specify the reason for leaving your last employment', NULL, NULL, 49, 0, NULL),
(7, 'If you are a contractor, do you have an ABN?', 'radio', NULL, NULL, NULL, NULL, NULL, 'If you are a contractor, do you have an ABN?', NULL, NULL, 50, 0, NULL),
(8, 'If you are a contractor, do you work for another company?', 'radio', NULL, NULL, NULL, NULL, NULL, 'If you are a contractor, do you work for another company?', NULL, NULL, 51, 0, NULL),
(9, 'If you are a contractor, do you employ others?', 'radio', NULL, NULL, NULL, NULL, NULL, 'If you are a contractor, do you employ others?', NULL, NULL, 52, 0, NULL);