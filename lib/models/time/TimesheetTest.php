...
class TimesheetTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
		...
		$this->assertTrue(mysql_query("INSERT INTO `hs_hr_time_event` (`time_event_id`, `project_id`, `employee_id`, `timesheet_id`, `start_time`, `end_time`, `reported_date`, `duration`, `description`) ".
