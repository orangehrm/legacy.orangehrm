...
class TimeController {
	...
	public function editTimesheet() {
		...
		$this->redirect($_GET['message'], "?timecode=Time&action=View_Timesheet&id={$timeEvents[0]->getTimesheetId()}");
	...
	public function validateTimeEvent($timeEvent, $timesheet) {
		...
		if (!CommonFunctions::IsValidId($timeEvent->getProjectId()) || $timeEvent->getProjectId() == 0) {
