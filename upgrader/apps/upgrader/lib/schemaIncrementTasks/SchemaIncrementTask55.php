...
class SchemaIncrementTask55 extends SchemaIncrementTask {
    ...
    public function loadSql() {
        ...
        $sql[] = "INSERT INTO ohrm_menu_item (`id`, `menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`) VALUES
                    ...
                    (4, 'Locations', 21, 2, 3, 200, NULL, 1),
                    (5, 'Structure', 22, 2, 3, 300, NULL, 1),
                    (6, 'Job', NULL, 1, 2, 200, NULL, 1),
                    ...
                    (12, 'Qualifications', NULL, 1, 2, 300, NULL, 1),
                    (13, 'Skills', 28, 12, 3, 100, NULL, 1),
                    (14, 'Education', 29, 12, 3, 200, NULL, 1),
                    (15, 'Licenses', 30, 12, 3, 300, NULL, 1),
                    (16, 'Languages', 31, 12, 3, 400, NULL, 1),
                    (17, 'Memberships', 32, 1, 2, 400, NULL, 1),
                    (18, 'Nationalities', 33, 1, 2, 500, NULL, 1),
                    (19, 'Users', 1, 1, 2, 600, NULL, 1),
                    (20, 'Email Notifications', NULL, 1, 2, 700, NULL, 1),
                    (21, 'Configuration', 34, 20, 3, 100, NULL, 1),
                    (22, 'Subscribe', 35, 20, 3, 200, NULL, 1),
                    (23, 'Project Info', NULL, 1, 2, 800, NULL, 1),
                    (24, 'Customers', 36, 23, 3, 100, NULL, 1),
                    (25, 'Projects', 37, 23, 3, 200, NULL, 1),
