...
<?php if ((isset($_GET['menu_no_top'])) && ($_GET['menu_no_top']=="eim") && $arrRights['view']) {  ?>
                    <TD width=158>
                      <ul id="menu">
						...
						<li id="projects"><a href="index.php?uniqcode=PRJ&menu_no=2&submenutop=EIMModule&menu_no_top=eim" ><?php echo $lang_Menu_Admin_Projects; ?></a></li>
</ul></TD>
...
<table width="100%">
<tr>
<td align="center"><a href="http://www.orangehrm.com" target="_blank">OrangeHRM</a> ver 2.2_01 &copy; OrangeHRM Inc. 2005 - 2007 All rights reserved.</td>
</tr>
</table>
<script language="javascript">
