...
class PluginAllTests
{
    ...
    public static function suite() {
        ...
        $suite = new PHPUnit_Framework_TestSuite('TimesheetCsvExtractoreAllTest');

        /* Service Test Cases */
        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmTimesheetCsvExtractorPlugin/test/model/service/TimesheetExtractorTimesheetServiceTest.php');
        
        /* Dao Test Cases */
        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmTimesheetCsvExtractorPlugin/test/model/dao/TimesheetExtractorTimesheetDaoTest.php');
        return $suite;
