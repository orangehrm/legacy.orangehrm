                                    ...
                                    <table width="550" cellspacing="0" cellpadding="0" class="data-table">
                                        ...
                                        <?php $empPassports = $form->empPassports;
                                            ...
                                            <tr class="<?php echo $cssClass;?>">
                                                ...
                                                <?php }else{
                                                    ?>
                                                <input type='hidden' class='checkbox' name='chkImmigrationUP[]' value='<?php echo $passport->seqno;?>' />
                                                <?php
                                                ...
                                                <td class="document">
                                                    <?php if ($immigrationPermission->canUpdate()) { ?>
                                                        <a href="#"><?php echo ($passport->type_flag == EmpPassPort::TYPE_PASSPORT)? __("Passport"):__("Visa");?></a>
                                                    <?php }else{?>
                                                        <?php echo ($passport->type_flag == EmpPassPort::TYPE_PASSPORT)? __("Passport"):__("Visa");?>
                                                    <?php }?>
                                                </td>
