...
class AccessFlowStateMachineServiceTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetWorkFlowStateMachineRecordsService() {
        ...
        $this->assertTrue($this->accessFlowStateMachineService->getWorkFlowStateMachineRecords(PluginWorkflowStateMachine::FLOW_EMPLOYEE) instanceof WorkflowStateMachine);
    }
