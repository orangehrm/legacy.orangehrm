 ...
 * @author irshad
 */
class AttachmentComponentCommon extends Component {
    ...
    public function addToCancel($path, $comment=null) {
    ...
    public function getActionStatusMessage() {
        return $this->selenium->getText("//div[@id='attachmentsMessagebar']");
    }
