...
5. Check All the CheckBoxes under the PIM->configure->optional Fields.
        
6. Run the PIM test suite (located in test/pim folder)
    phpunit PIMFunctionalPluginAllTests.php