 ...
 * @method OhrmEmail           setEmailTemplate()  Sets the current record's "EmailTemplate" collection
 * @method OhrmEmail           setEmailProcessor() Sets the current record's "EmailProcessor" collection
 * 
 * @package    orangehrm
